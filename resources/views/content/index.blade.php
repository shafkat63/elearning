        ...
        <div class="card-body">
            <h4 class="card-title">
                <div class="row">
                    ...
                    <div class="col-md-2">
                      <a href="{{url('Content/create')}}" class="btn btn-gradient-success  btn-sm btn-icon-text">
